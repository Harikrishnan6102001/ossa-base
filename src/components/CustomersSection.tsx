...
const CustomersSection = () => {
  ...
  const customers = [
    'Whirlpool', 'P&G', 'NMD', 'TVS', 'RORITO', 'CEPHAS', 'MOTHERSON', 'CELLO',
    'BRITE', 'RIALTO', 'SUBA PLASTICS', 'NATIONAL', 'POINTEC', 'SISEL', 'PRISTINE',
    'AVINASHINDS', 'GMD', 'AVAION', 'KGOC', 'SMPI', 'PML', 'IWI', 'TIGER'
  ];
            ...
            >
              <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-110 border border-gray-100 hover:border-transparent flex items-center justify-center group relative overflow-hidden">
                ...
                <div className="text-center relative z-10">
                  <div className={`w-16 h-16 bg-gradient-to-br ${gradients[index % gradients.length]} rounded-full flex items-center justify-center mb-3 mx-auto group-hover:scale-110 transition-all duration-300 shadow-lg`}>
